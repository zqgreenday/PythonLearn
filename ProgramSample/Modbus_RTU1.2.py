...
if __name__ == '__main__':
    ...
    frame4.place(x=6, y=5, width=486, height=55)
    ...
    mbComPort = getdata(comboxlist1)
    baudrate = convert(comboxlist2)
    databit = convert(comboxlist3)
    parity = getdata(comboxlist4)
    stopbit = convert(comboxlist5)
    ...
    button7 = tkinter.Button(root, text='Quit', command=root.quit)
    button7.place(x=6, y=255, width=50)
